...
*        V1.1    2019-02-05 armfly    增加24C04芯片驱动（解决BUG)
*
...
#if EE_ADDR_BYTES == 1
    i2c_SendByte(EE_DEV_ADDR | I2C_WR | (((_usAddress >> 8) & 0x07) << 1)); /* 此处是写指令 */
#else
...
#if EE_ADDR_BYTES == 1
                i2c_SendByte(EE_DEV_ADDR | I2C_WR | (((usAddr >> 8) & 0x07) << 1)); /* 此处是写指令 */
#else
                i2c_SendByte(EE_DEV_ADDR | I2C_WR);
#endif
