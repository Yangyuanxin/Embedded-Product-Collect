#if !defined(AFX_DIALOGCONFIGURATION_M05XCN_H__E0CD7A09_C5DC_481E_A871_03B422E615F8__INCLUDED_)
#define AFX_DIALOGCONFIGURATION_M05XCN_H__E0CD7A09_C5DC_481E_A871_03B422E615F8__INCLUDED_
...
class CDialogConfiguration_M05xCN : public CDialogResize2
{
// Construction
public:
...
// Dialog Data
	//{{AFX_DATA(CDialogConfiguration_M05xCN)
	enum { IDD = IDD_DIALOG_CONFIGURATION_M051CN };
...
// Overrides
	...
	//{{AFX_VIRTUAL(CDialogConfiguration_M05xCN)
	protected:
...
protected:
	...
	//{{AFX_MSG(CDialogConfiguration_M05xCN)
