...
/////////////////////////////////////////////////////////////////////////////
// CDialogConfiguration_M05xCN dialog


CDialogConfiguration_M05xCN::CDialogConfiguration_M05xCN(CWnd* pParent /*=NULL*/)
	: CDialogResize2(CDialogConfiguration_M05xCN::IDD, pParent)
{
	//{{AFX_DATA_INIT(CDialogConfiguration_M05xCN)
	m_nRadioClk = -1;
	m_nRadioBov = -1;
	m_nRadioBS = -1;
	m_sConfigValue0 = _T("");
...
void CDialogConfiguration_M05xCN::DoDataExchange(CDataExchange* pDX)
{
	CDialogResize2::DoDataExchange(pDX);
	//{{AFX_DATA_MAP(CDialogConfiguration_M05xCN)
...
BEGIN_MESSAGE_MAP(CDialogConfiguration_M05xCN, CDialog)
	//{{AFX_MSG_MAP(CDialogConfiguration_M05xCN)
...
/////////////////////////////////////////////////////////////////////////////
// CDialogConfiguration_M05xCN message handlers

BOOL CDialogConfiguration_M05xCN::OnInitDialog() 
{
...
void CDialogConfiguration_M05xCN::ConfigToGUI(int nEventID)
{
...
void CDialogConfiguration_M05xCN::GUIToConfig(int nEventID)
{
	unsigned int uConfig0 = m_ConfigValue.m_value[0];
...
void CDialogConfiguration_M05xCN::OnGUIEvent(int nEventID) 
{
...
void CDialogConfiguration_M05xCN::OnRadioBov() 
{
	OnGUIEvent();
}

void CDialogConfiguration_M05xCN::OnRadioClk() 
{
	// TODO: Add your control notification handler code here
	OnGUIEvent();
}

void CDialogConfiguration_M05xCN::OnRadioBs() 
{
	// TODO: Add your control notification handler code here
	OnGUIEvent();
}

void CDialogConfiguration_M05xCN::OnRadioIO() 
{
	// TODO: Add your control notification handler code here
	OnGUIEvent();
}

void CDialogConfiguration_M05xCN::OnCheckClick() 
{
	// TODO: Add your control notification handler code here
	OnGUIEvent();
}
...
void CDialogConfiguration_M05xCN::OnCheckClickWDTPD() 
{
	// TODO: Add your control notification handler code here
	OnGUIEvent(IDC_CHECK_WDT_POWER_DOWN);
}

void CDialogConfiguration_M05xCN::OnCheckClickWDT() 
{
	// TODO: Add your control notification handler code here
	OnGUIEvent(IDC_CHECK_WDT_ENABLE);
}

void CDialogConfiguration_M05xCN::OnChangeEditFlashBaseAddress() 
{
...
void CDialogConfiguration_M05xCN::OnOK() 
{
