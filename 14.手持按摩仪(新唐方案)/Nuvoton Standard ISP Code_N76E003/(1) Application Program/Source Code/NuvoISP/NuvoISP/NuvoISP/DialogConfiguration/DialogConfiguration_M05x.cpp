...
CDialogConfiguration_M05x::CDialogConfiguration_M05x(CWnd* pParent /*=NULL*/)
	: CDialogResize2(CDialogConfiguration_M05x::IDD, pParent)
{
...
void CDialogConfiguration_M05x::ConfigToGUI()
{
...
void CDialogConfiguration_M05x::GUIToConfig()
{
	unsigned int uConfig0 = m_ConfigValue.m_value[0];
...
void CDialogConfiguration_M05x::OnChangeEditFlashBaseAddress() 
{
...
CString CDialogConfiguration_M05x::GetConfigWarning(const CAppConfig::M05x_configs_t &config)
{
	CString str;
