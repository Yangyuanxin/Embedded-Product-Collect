...
CDialogConfiguration_N572F064::CDialogConfiguration_N572F064(CWnd* pParent /*=NULL*/)
	: CDialogResize2(CDialogConfiguration_N572F064::IDD, pParent)
{
...
void CDialogConfiguration_N572F064::DoDataExchange(CDataExchange* pDX)
{
...
BEGIN_MESSAGE_MAP(CDialogConfiguration_N572F064, CDialog)
...
BOOL CDialogConfiguration_N572F064::OnInitDialog() 
{
...
void CDialogConfiguration_N572F064::ConfigToGUI()
{
...
void CDialogConfiguration_N572F064::GUIToConfig()
{
	unsigned int uConfig0 = m_ConfigValue.m_value[0];
...
void CDialogConfiguration_N572F064::OnRadioClick() 
{
...
void CDialogConfiguration_N572F064::OnCheckClick() 
{
	// TODO: Add your control notification handler code here
	OnRadioClick();
}

void CDialogConfiguration_N572F064::OnOK() 
{
...
CString CDialogConfiguration_N572F064::GetConfigWarning(const CAppConfig::N572_configs_t &config)
{
	CString str;
...
void CDialogConfiguration_N572F064::OnChangeEditFlashInfo1() 
{
