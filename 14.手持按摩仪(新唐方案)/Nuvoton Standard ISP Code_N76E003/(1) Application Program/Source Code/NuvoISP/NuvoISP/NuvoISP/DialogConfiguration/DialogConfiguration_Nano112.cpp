...
CDialogConfiguration_Nano112::CDialogConfiguration_Nano112(unsigned int uProgramMemorySize,
														   CWnd* pParent /*=NULL*/)
	: CDialogResize2(CDialogConfiguration_Nano112::IDD, pParent)
...
BEGIN_MESSAGE_MAP(CDialogConfiguration_Nano112, CDialog)
	...
	ON_BN_CLICKED(IDC_RADIO_HXT_12_16, OnRadioHxt)
	ON_BN_CLICKED(IDC_RADIO_HXT_8_12, OnRadioHxt)
	ON_BN_CLICKED(IDC_RADIO_HXT_L8, OnRadioHxt)
	ON_WM_SIZE()
	ON_WM_VSCROLL()
	ON_WM_HSCROLL()
	ON_WM_GETMINMAXINFO()
...
void CDialogConfiguration_Nano112::GUIToConfig()
{
	...
	{
	case 0:
		uConfig0 |= NANO100_FLASH_CONFIG_HXT_H16; break;
	case 1:
		uConfig0 |= NANO100_FLASH_CONFIG_HXT_12_16; break;
	case 2:
		uConfig0 |= NANO100_FLASH_CONFIG_HXT_8_12; break;
	case 3:
		uConfig0 |= NANO100_FLASH_CONFIG_HXT_L8; break;
	//case -1: break;
	default:
		/* Keep old value */
...
void CDialogConfiguration_Nano112::OnRadioBov() 
{
...
void CDialogConfiguration_Nano112::OnRadioClk() 
{
	// TODO: Add your control notification handler code here
	OnRadioBov();
}

void CDialogConfiguration_Nano112::OnRadioBs() 
{
	// TODO: Add your control notification handler code here
	OnRadioBov();
}

void CDialogConfiguration_Nano112::OnCheckClick() 
{
	// TODO: Add your control notification handler code here
	OnRadioBov();
}

void CDialogConfiguration_Nano112::OnCheckClickWDT() 
{
	// TODO: Add your control notification handler code here
	OnRadioBov();
}

void CDialogConfiguration_Nano112::OnChangeEditFlashBaseAddress() 
{
...
void CDialogConfiguration_Nano112::OnRadioBor() 
{
	// TODO: Add your control notification handler code here
	OnRadioBov();	
}

void CDialogConfiguration_Nano112::OnRadioHxt()
{
	// TODO: Add your control notification handler code here
	OnRadioBov();
}
