...
CDialogConfiguration_NUC103BN::CDialogConfiguration_NUC103BN(unsigned int uProgramMemorySize,
															 ...
															 CWnd* pParent /*=NULL*/)
	: CDialogResize2(CDialogConfiguration_NUC103BN::IDD, pParent)
...
void CDialogConfiguration_NUC103BN::OnRadioBov() 
{
	OnGUIEvent();
}

void CDialogConfiguration_NUC103BN::OnRadioClk() 
{
	// TODO: Add your control notification handler code here
	OnGUIEvent();
}

void CDialogConfiguration_NUC103BN::OnRadioBs() 
{
	// TODO: Add your control notification handler code here
	OnGUIEvent();
}

void CDialogConfiguration_NUC103BN::OnCheckClick() 
{
	// TODO: Add your control notification handler code here
	OnGUIEvent();
}

void CDialogConfiguration_NUC103BN::OnCheckClickDFVSEN() 
{
	// TODO: Add your control notification handler code here
	OnGUIEvent(IDC_CHECK_DATA_FLASH_VAR_SIZE_ENABLE);
}

void CDialogConfiguration_NUC103BN::OnCheckClickDFEN()
{
	// TODO: Add your control notification handler code here
...
void CDialogConfiguration_NUC103BN::OnCheckClickWDT() 
{
	// TODO: Add your control notification handler code here
...
CString CDialogConfiguration_NUC103BN::GetConfigWarning(const CAppConfig::NUC1xx_configs_t &config)
{
	CString str;
...
void CDialogConfiguration_NUC103BN::OnRadioIO() 
{
	// TODO: Add your control notification handler code here
	OnGUIEvent(0);
}

void CDialogConfiguration_NUC103BN::OnRadioGpf() 
{
	// TODO: Add your control notification handler code here
	OnGUIEvent(0);
}
