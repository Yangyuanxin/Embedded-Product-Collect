...
class CDialogConfiguration_NUC103BN : public CDialogResize2
{
// Construction
public:
	CDialogConfiguration_NUC103BN(unsigned int uProgramMemorySize = 64 * 1024,
...
// Dialog Data
	//{{AFX_DATA(CDialogConfiguration_NUC103BN)
	enum { IDD = IDD_DIALOG_CONFIGURATION_NUC103BN };
