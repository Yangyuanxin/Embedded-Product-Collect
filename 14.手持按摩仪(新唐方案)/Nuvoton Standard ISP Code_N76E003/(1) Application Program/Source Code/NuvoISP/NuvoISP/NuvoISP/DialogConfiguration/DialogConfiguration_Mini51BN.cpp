...
CDialogConfiguration_Mini51BN::CDialogConfiguration_Mini51BN(unsigned int uProgramMemorySize,
															 CWnd* pParent /*=NULL*/)
	: CDialogResize2(CDialogConfiguration_Mini51BN::IDD, pParent)
...
void CDialogConfiguration_Mini51BN::DoDataExchange(CDataExchange* pDX)
{
	...
	//{{AFX_DATA_MAP(CDialogConfiguration_Mini51BN)
...
BOOL CDialogConfiguration_Mini51BN::OnInitDialog() 
{
...
void CDialogConfiguration_Mini51BN::GUIToConfig()
{
	//unsigned int uConfig0 = m_ConfigValue.m_value[0];
...
void CDialogConfiguration_Mini51BN::OnOK() 
{
...
CString CDialogConfiguration_Mini51BN::GetConfigWarning(const CAppConfig::Mini51_configs_t &config)
{
	CString str;
...
void CDialogConfiguration_Mini51BN::OnVScroll(UINT nSBCode, UINT nPos, CScrollBar* pScrollBar)
{
