...
/////////////////////////////////////////////////////////////////////////////
// CDialogConfiguration_Nano100BN dialog


CDialogConfiguration_Nano100BN::CDialogConfiguration_Nano100BN(unsigned int uProgramMemorySize,
															   CWnd* pParent /*=NULL*/)
	: CDialogResize2(CDialogConfiguration_Nano100BN::IDD, pParent)
	, m_uProgramMemorySize(uProgramMemorySize)
{
	//{{AFX_DATA_INIT(CDialogConfiguration_Nano100BN)
	m_nRadioClk = -1;
	m_nRadioBor = -1;
	m_nRadioBS = -1;
	m_sConfigValue0 = _T("");
...
void CDialogConfiguration_Nano100BN::DoDataExchange(CDataExchange* pDX)
{
	CDialogResize2::DoDataExchange(pDX);
	//{{AFX_DATA_MAP(CDialogConfiguration_Nano100BN)
...
BEGIN_MESSAGE_MAP(CDialogConfiguration_Nano100BN, CDialog)
	//{{AFX_MSG_MAP(CDialogConfiguration_Nano100BN)
...
/////////////////////////////////////////////////////////////////////////////
// CDialogConfiguration_Nano100BN message handlers

BOOL CDialogConfiguration_Nano100BN::OnInitDialog() 
{
...
void CDialogConfiguration_Nano100BN::ConfigToGUI()
{
...
void CDialogConfiguration_Nano100BN::OnRadioBov() 
{
...
void CDialogConfiguration_Nano100BN::OnRadioClk() 
{
	// TODO: Add your control notification handler code here
	OnRadioBov();
}

void CDialogConfiguration_Nano100BN::OnRadioBs() 
{
	// TODO: Add your control notification handler code here
	OnRadioBov();
}

void CDialogConfiguration_Nano100BN::OnCheckClick() 
{
	// TODO: Add your control notification handler code here
	OnRadioBov();
}

void CDialogConfiguration_Nano100BN::OnCheckClickWDT() 
{
	// TODO: Add your control notification handler code here
	OnRadioBov();
}

void CDialogConfiguration_Nano100BN::OnChangeEditFlashBaseAddress() 
{
...
void CDialogConfiguration_Nano100BN::OnOK() 
{
...
CString CDialogConfiguration_Nano100BN::GetConfigWarning(const CAppConfig::Nano100_configs_t &config)
{
	CString str;
...
void CDialogConfiguration_Nano100BN::OnRadioBor() 
{
	// TODO: Add your control notification handler code here
	OnRadioBov();
}

void CDialogConfiguration_Nano100BN::OnDeltaposSpinDataFlashSize(NMHDR *pNMHDR, LRESULT *pResult)
{
...
void CDialogConfiguration_Nano100BN::OnVScroll(UINT nSBCode, UINT nPos, CScrollBar* pScrollBar)
{
