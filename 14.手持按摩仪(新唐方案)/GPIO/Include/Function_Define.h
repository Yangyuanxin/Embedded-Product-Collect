...
#define 	TIMER2_DIV_1			T2MOD|=0x00;T2MOD&=0x0F
...
#define   TIMER3_DIV_1                        T3CON&=~SET_BIT2;T3CON&=~SET_BIT1;T3CON&=~SET_BIT0;
#define   TIMER3_DIV_2                        T3CON&=~SET_BIT2;T3CON&=~SET_BIT1;T3CON|=SET_BIT0;
#define   TIMER3_DIV_4                        T3CON&=~SET_BIT2;T3CON|=~SET_BIT1;T3CON&=~SET_BIT0;
#define   TIMER3_DIV_8                        T3CON&=~SET_BIT2;T3CON|=SET_BIT1;T3CON|=SET_BIT0;
#define   TIMER3_DIV_16                       T3CON|=SET_BIT2;T3CON&=~SET_BIT1;T3CON&=~SET_BIT0;
#define   TIMER3_DIV_32                       T3CON|=SET_BIT2;T3CON&=~SET_BIT1;T3CON|=SET_BIT0;
#define   TIMER3_DIV_64                       T3CON|=SET_BIT2;T3CON|=SET_BIT1;T3CON&=~SET_BIT0;
#define   TIMER3_DIV_128                      T3CON|=SET_BIT2;T3CON|=SET_BIT1;T3CON|=SET_BIT0;
...
#define		PWM_CLOCK_DIV_1					PWMCON1|=0x00;PWMCON1&=0xF0
