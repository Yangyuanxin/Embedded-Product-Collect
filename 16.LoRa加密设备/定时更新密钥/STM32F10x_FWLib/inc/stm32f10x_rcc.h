...
#define RCC_APB2Periph_AFIO              ((uint32_t)0x00000001)		//bit0
#define RCC_APB2Periph_GPIOA             ((uint32_t)0x00000004)		//bit2
...
#define RCC_APB2Periph_TIM1              ((uint32_t)0x00000800)		//bit11
#define RCC_APB2Periph_SPI1              ((uint32_t)0x00001000) 	//bit12
