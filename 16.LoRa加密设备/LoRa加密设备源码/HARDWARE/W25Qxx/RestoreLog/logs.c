...
//	* 备注：	无
//******************************************/
//void RestoreOperateLog(u8 *SourceBuf,u16 RestoreCode,u8 AdminCode,u8 Result)
//{
//	//判断是否超过存储地址
...
//	* 备注：
//****************************************************/
//void ExportOperateLog(u8 *DestBuf)
//{
//	W25QXX_Read(DestBuf,OPERATE_LOG_BASE_ADDR+OperateReadAddr,MIN_LOG_PACK_SIZE);	//读取W25Qxx数据
//	OperateReadAddr += MIN_LOG_PACK_SIZE; 											//偏移地址
//}
...
//	* 备注：	无
//******************************************/
//void RestoreSystemLog(u8 *SourceBuf,u16 _RestoreCode,u8 Result)
//{
//	//判断是否超过存储地址
//	if( (SYSTEM_LOG_BASE_ADDR+SystemWriteAddr) < SYSTEM_LOG_SZIE )
//	{
//		//合成系统日志
//		MixSystemLogData(SourceBuf,_RestoreCode,Result);
//		//将系统日志写入存储芯片
...
//	* 备注：
//****************************************************/
//void ExportSystemLog(u8 *DestBuf)
//{
//	W25QXX_Read(DestBuf,SYSTEM_LOG_BASE_ADDR+SystemReadAddr,MIN_LOG_PACK_SIZE);	//读取W25Qxx数据
//	SystemReadAddr += MIN_LOG_PACK_SIZE; 										//偏移地址
//}
...
//	* 备注：	无
//******************************************/
//void RestoreCommunicateLog(u8 *SourceBuf,u8 Result)
//{
//	//判断是否超过存储地址
...
//	* 备注：
//****************************************************/
//void ExportCommunicateLog(u8 *DestBuf)
//{
//	//读取W25Qxx数据
...
//	* 备注：	无
//******************************************/
//void RestoreEncryptLog(u8 *SourceBuf,u8 Result)
//{
//	//判断是否超过存储地址
...
//	* 备注：
//****************************************************/
//void ExportEncryptLog(u8 *DestBuf)
//{
//	//读取W25Qxx数据
