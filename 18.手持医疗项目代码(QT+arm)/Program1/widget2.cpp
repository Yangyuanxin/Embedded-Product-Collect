...
bool Widget2::eventFilter(QObject *watched, QEvent *e) {
    ...
    QString file_name = name + "_bs.txt";
    qDebug() << file_name;
    QFile qf(file_name);
    int count = 1;
...
void Widget2::paintOnWidget(QWidget *w) {
...
void Widget2::paintWidget(QWidget *w, int x, int y, int i)
{
    QPainter paint(w);
...
void Widget2::SetPatientName(QString name)
{
       this->name = name;
}
