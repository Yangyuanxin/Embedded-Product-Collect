...
#define OS_MAX_EVENTS            32    /* Max. number of event control blocks in your application      */
                                       // 最大事件数,决定事件控制块的个数及尺寸
...
#define OS_SEM_ACCEPT_EN          1    /*    Include code for OSSemAccept()            GH                */
...
#define OS_SEM_SET_EN             1    /*    Include code for OSSemSet()                               */
                                       ...
                                       /* --------------------- TIME MANAGEMENT ---------------------- */
#define OS_TIME_DLY_HMSM_EN       0    /*     Include code for OSTimeDlyHMSM()          GH               */
