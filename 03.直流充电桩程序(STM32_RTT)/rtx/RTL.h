...
#define HTONS(n) (unsigned short)(__REV16(n))
...
#define HTONL(n) (unsigned int)(__REV(n))

#endif /* HTONl */

////饱和运算
////无符号
//#define USAT(a, b) __USAT(a, b)
////有符号
//#define SSAT(a, b) __SSAT(a, b)
...
//static inline unsigned char clz(unsigned int value)
//{
