...
static void change_color(const char * sFormat, ...)
{
	va_list ParamList;
	va_start(ParamList, sFormat);
...
int RTT_dbg_msg(const char * sFormat, ...)
{
	...
	change_color("%s", RTT_CTRL_TEXT_BRIGHT_GREEN);
...
int RTT_dbg_error(const char * sFormat, ...)
{
	...
	change_color("%s", RTT_CTRL_TEXT_BRIGHT_RED);
...
int RTT_dbg_msg_color(unsigned char c, const char * sFormat, ...)
{
	va_list ParamList;
